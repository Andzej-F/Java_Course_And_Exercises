...
/* Don't give me five!
source: https://www.codewars.com/kata/5813d19765d81c592200001a/train/java
Don't give me five!
In this kata you get the start number and the end number of a region
and should return the count of all numbers except numbers with a 5 in
...
public class DontGiveMeFive {
  public static int dontGiveMeFive(int start, int end) {
    ...
    for (int i = start; i <= end; i++) {
      String nbrText = Integer.toString(i);
      Matcher matcher = pattern.matcher(nbrText);
      if (matcher.find()) {
        continue;
      }
      count++;
...
//    Pattern pattern = Pattern.compile("5+");
//    Matcher matcher = pattern.matcher("151");
//    System.out.println(matcher.find());


    System.out.println(dontGiveMeFive(1, 9));
    System.out.println(dontGiveMeFive(4, 17));
//    System.out.println("5".matches("5"));
//    System.out.println("15".replaceAll("5", "*"));
//    System.out.println("15".replaceAll("5", "*"));
  }
}
