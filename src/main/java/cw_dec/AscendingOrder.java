...
be sorted in ascending order since all (zero) adjacent pairs of integers
...
N.B. If your solution passes all fixed tests but fails at the random tests, make
sure you aren't mutating the input array.
 */
public class AscendingOrder {
  ...
  public static void main(String[] args) {
    int[] arr1 = {1, 2, 4, 7, 19};
    int[] arr2 = {1, 2, 3, 4, 5};
    int[] arr3 = {1, 6, 10, 18, 2, 4, 20};
    int[] arr4 = {9, 8, 7, 6, 5, 4, 3, 2, 1};
    System.out.println(isAscOrder(arr1));// true
    System.out.println(isAscOrder(arr2));// true
    System.out.println(isAscOrder(arr3));// false
    System.out.println(isAscOrder(arr4));// false
  }
}
