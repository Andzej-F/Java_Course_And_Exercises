...
/*
source: https://www.codewars.com/kata/56541980fa08ab47a0000040/train/java

In a factory a printer prints labels for boxes. For one kind of
boxes the printer has to use colors which, for the sake of
...
public class PrinterErrors {
  ...
  public static String printerError(String s) {
    int errCount = s.replaceAll("[a-m]", "").length();
    return errCount + "/" + s.length();
  }

  
  public static void main(String[] args) {
    System.out.println(PrinterErrors.printerError("aaabbbbhaijjjm"));
    System.out.println(PrinterErrors.printerError("aaaxbbbbyyhwawiwjjjwwm"));
  }
}
